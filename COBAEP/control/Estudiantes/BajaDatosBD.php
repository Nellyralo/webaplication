...
<link rel="stylesheet" type="text/css" href="../styleJC.ccs">
...
<h1> Baja </h1></br>
	...
	echo '<th> <span class="tabla"> Nombre o nombres del alumno </span></th>';
	...
	echo '<th> <span class="tabla"> Numero de seguro social</span> </th>';
	...
	echo '<form action="BajaDatosconfirm.php" method=post>';
	echo "<input style='visibility:hidden;' name='Campo' type='Text' value='". $tipoBusqueda."'>";
	echo "<input  style='visibility:hidden;' name='Criterio' type='Text' value='". $terminobusqueda ."' >";
	...
	echo '</table> </center>';
	echo '<td align="center" colspan="6"><a title=" Regresar? " href="Bajadatos.php?matricula=<?php echo $row[matricula]; ?>"><font size=3 color="#003300"><input type="Submit" value="REGRESAR"><br></font></td>';
	break;	
		}
	$db->close();
?>
